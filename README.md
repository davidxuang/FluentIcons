...
| [![FluentIcons.Common.Extensions](https://img.shields.io/nuget/v/FluentIcons.Common.Extensions?label=FluentIcons.Common.Extensions)](https://www.nuget.org/packages/FluentIcons.Common.Extensions) | _meta package_                                                                                                                                                                                                                                                                                                                            |
...
| [![FluentIcons.WinForms](https://img.shields.io/nuget/v/FluentIcons.WinForms?label=FluentIcons.WinForms)](https://www.nuget.org/packages/FluentIcons.WinForms)                                                         | ![](https://cdn.jsdelivr.net/gh/davidxuang/FluentIcons@static/assets/dotnet.svg) .NET Framework 4.5 <br/> ![](https://cdn.jsdelivr.net/gh/davidxuang/FluentIcons@static/assets/dotnet.svg) .NET 6                                                                                                                                       |
...
| [![FluentIcons.Wpf](https://img.shields.io/nuget/v/FluentIcons.Wpf?label=FluentIcons.Wpf)](https://www.nuget.org/packages/FluentIcons.Wpf)                                                         | ![](https://cdn.jsdelivr.net/gh/davidxuang/FluentIcons@static/assets/dotnet.svg) .NET Framework 4.5 <br/> ![](https://cdn.jsdelivr.net/gh/davidxuang/FluentIcons@static/assets/dotnet.svg) .NET 6                                                                                                                                       |
...
`<SymbolImageSource>` and `SymbolImageSourceExtension` are provided on MAUI as stand-ins of icon sources.
...
⛔ There are two rendering backends, GDI and GDI+ (for Windows 8+), as [CFF support is missing from GDI+](https://learn.microsoft.com/en-us/windows/win32/gdiplus/-gdiplus-creating-a-private-font-collection-use) on legacy platforms. This means that the alpha channel of `ForeColor` will be ignores on platforms supported by GDI.

⛔ Color icons will not work on WinForms.
