...
| [![FluentIcons.WinForms](https://img.shields.io/nuget/v/FluentIcons.WinForms?label=FluentIcons.WinForms)](https://www.nuget.org/packages/FluentIcons.WinForms)                                                         | ![](https://cdn.jsdelivr.net/gh/davidxuang/FluentIcons@static/assets/dotnet.svg) .NET Framework 4.6.2 <br/> ![](https://cdn.jsdelivr.net/gh/davidxuang/FluentIcons@static/assets/dotnet.svg) .NET 6                                                                                                                                       |
